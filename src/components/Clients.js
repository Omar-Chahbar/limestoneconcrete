    ...
    return (
        <div className="clients">
            <section data-aos="fade-up">
                <div className="py-4">
                        <h2 className="my-2 text-center text-3xl text-gray-100 uppercase font-bold">Our Clients</h2>
                        <div className='flex justify-center'>
                            <div className='w-24 border-b-4 border-gray-100'></div>
                        </div>
                        <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-gray-100">Some of our clients.</h2>
                    </div>
